// ===== BATE-PAPO AVANÇADO - FIREBASE WEB V8 - v515 =====
...
try { if ('serviceWorker' in navigator) navigator.serviceWorker.register('service-worker.js?v=509').catch(console.warn); } catch(e) {}
...
try { if ('serviceWorker' in navigator) navigator.serviceWorker.register('service-worker.js?v=510').catch(console.warn); } catch(e) {}
...
try { if ('serviceWorker' in navigator) navigator.serviceWorker.register('service-worker.js?v=511').catch(console.warn); } catch(e) {}
...
async function initPushV512(){
  try {
    ...
    if (FCM_VAPID_KEY_V512.includes('COLE_SUA_CHAVE')) {
    ...
    const token = await messaging.getToken({ vapidKey: FCM_VAPID_KEY_V512, serviceWorkerRegistration: reg });
    if (!token) return;
...
try { window.APP_VERSION = '514'; if ($('debugText')) $('debugText').textContent = 'Projeto: ferramentas-projeto | v514'; } catch(e) {}
