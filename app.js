...
try { if ('serviceWorker' in navigator) navigator.serviceWorker.register('service-worker.js?v=512').catch(console.warn); } catch(e) {}
...
async function initPushV512(){
  try {
    ...
    const reg = await navigator.serviceWorker.register('service-worker.js?v=512');
