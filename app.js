...
try { if ($('debugText')) $('debugText').textContent = 'Projeto: ' + firebaseConfig.projectId + ' | v507 WebRTC'; } catch(e) {}
try { if ('serviceWorker' in navigator) navigator.serviceWorker.register('service-worker.js?v=507').catch(console.warn); } catch(e) {}
